        ...
        <div class="bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl p-6 sm:p-8">
            ...
            <form id="tambahBarangForm" method="POST" action="" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="flex flex-col-reverse sm:flex-row items-center justify-end gap-3 pt-4 border-t border-slate-800">
                    <a href="/pekerja/index.php" class="w-full sm:w-auto text-center px-5 py-3 sm:py-2.5 rounded-xl border border-slate-700 text-slate-300 hover:bg-slate-800 text-sm font-semibold transition-all">Batal</a>
